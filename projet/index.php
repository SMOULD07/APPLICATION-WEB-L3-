...
<html>
  <body>
    ...
    <nav style="display: block; background-image: url('images/ban.jpg')">
     ...
     <div class="links" style="display: flex; font-size: 1.1rem;">
        ...
        <div class="link" style="width:10rem"><a href="#" style="text-decoration: none; color: black">Home</a></div>
        ...
        <div class="link"><a href="inscription/inscripconx.php" style="color:black; text-decoration:none; cursor:pointer;">S'inscrire/Se connecter</a></div>
     </div>
